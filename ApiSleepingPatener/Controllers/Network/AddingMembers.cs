...
//        //    //var usercheckPhone = dc.NewUserRegistrations.Where(a => a.Phone.Equals(model.Phone)).FirstOrDefault();
//        //    var images = dc.NewUserRegistrations.Where(a => a.UserId == userId).FirstOrDefault();
//        //    //var userimage = dc.
//        //    if (images == null)
//        //    {
...
//        //    else
//        //    {
//        //        return Ok(new { success = true, message = images });
//        //    }
//        //}



//        //public byte[] GetProfileImageFromDataBase(int Id)
//        //{
//        //    sleepingtestEntities db = new sleepingtestEntities();
//        //    var q = from temp in db.NewUserRegistrations where temp.UserId == Id select temp.ProfileImage;
//        //    byte[] cover = q.First();
//        //    return cover;
