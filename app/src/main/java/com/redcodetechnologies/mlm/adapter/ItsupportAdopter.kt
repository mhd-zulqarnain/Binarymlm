...
import com.redcodetechnologies.mlm.R.drawable.wallet
import com.redcodetechnologies.mlm.models.Inbox


class ItsupportAdopter (var datalist: ArrayList<Inbox>): RecyclerView.Adapter<ItsupportAdopter.ViewHolder>() {
