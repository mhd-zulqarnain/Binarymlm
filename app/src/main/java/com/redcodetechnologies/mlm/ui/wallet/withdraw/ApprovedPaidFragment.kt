...
class ApprovedPaidFragment : Fragment() {
    ...
    fun getPendingWithdrawalList() {
        ...
        val thismothObservable: Observable<ArrayList<WithdrawalRequestModal>> = MyApiRxClint.getInstance()!!.getService()!!.getApprovedPaid()
