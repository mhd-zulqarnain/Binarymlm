...
class DashBoardFragment : Fragment() {
    ...
    var list: ArrayList<Advertisement> = ArrayList()
...
//        list.add(Advertisement("One Plus"))
//        list.add(Advertisement("I phone"))
//        list.add(Advertisement("Black berry"))
//        list.add(Advertisement("Oppo"))
