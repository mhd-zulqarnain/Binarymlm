...
class VideoPackAdapter(var ctx: Context, var list: ArrayList<VideosModal>, private val onClick:(VideosModal)->Unit) : RecyclerView.Adapter<VideoPackAdapter.MyViewHolder>() {
